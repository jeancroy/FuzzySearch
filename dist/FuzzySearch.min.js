...
!function () {
    ...
    b.update = function (a, b, c) {
        ...
        setOptions: function (b, c) {
            ...
            if ("keys"in a && void 0 !== (c = a.keys)) {
                var g, h, i = Object.prototype.toString.call(c);
                if (this.tags = null, "[object String]" === i)this.keys = c.length ? [c] : []; else if ("[object Object]" === i) {
                    this.keys = [], this.tags = [], g = 0;
                    for (var j in c)c.hasOwnProperty(j) && (this.tags[g] = j, this.keys[g] = c[j], g++)
                } else this.keys = c;
                for (c = this.keys, h = c.length, g = -1; ++g < h;)c[g] = d(c[g], ["item", "."]);
                this.tags || (this.tags = c), this.tags_re = e(this.tags)
            }
            (null === this.acro_re || "acronym_tok"in a) && (this.acro_re = f(b.acronym_tok)), (null === this.token_re || "token_split"in a) && (this.token_re = b.token_split), (a.dirty || "source"in a || "keys"in a) && (b.lazy ? this.dirty = !0 : (this._prepSource(this.source, this.keys, !0), this.dirty = !1))
        }
    }), c(a.prototype, {
    ...
    return a.filterSize = function (a, b, c) {
        ...
        var e = d.highlight_before, f = d.highlight_after, g = d.score_per_token, h = d.score_test_fused, i = d.score_acronym, j = d.token_split, k = d.normalize(b), l = d.normalize(c), m = k.split(j), n = l.split(j), o = [], p = [];
        q(c, j, o, p);
        var r = [], s = [], t = 0, u = 0;
        ...
        var g, h, i = 100, j = -10, k = -1, l = 0, m = 1, n = 2, o = 3, p = f.score_acronym, q = f.acronym_tok, r = Math.min(b.length + 1, f.token_query_max_length), s = Math.min(c.length + 1, f.token_field_max_length), t = s > r ? r : s, u = 0;
